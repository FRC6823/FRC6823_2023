...
public class AutoCommandGroup extends SequentialCommandGroup{
    ...
    public AutoCommandGroup(RobotContainer container){
        ...
        addCommands(new InstantCommand(() -> positionHandler.setPose(4)), new WaitCommand(5), new InstantCommand(() -> pneumatic.togglePneumaticState()));
        // addCommands(new InstantCommand(() -> positionHandler.setPose(4)), new WaitUntilPose(lift, pulley, gripperAngle), new WaitCommand(2), new InstantCommand(() -> pneumatic.togglePneumaticState()));
