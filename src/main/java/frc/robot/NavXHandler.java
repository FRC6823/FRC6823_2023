...
public class NavXHandler {
    ...
    public void setInitialAngle() {
        initialAngle = getAngleRad().getRadians();
    }
    ...
    public void printEverything() {
        ...
        SmartDashboard.putNumber("NavX Angle", MathUtil.mod(getAngleRad().getRadians(), 2 * Math.PI));
    }

    public Rotation2d getAngleRad() {
        return new Rotation2d(MathUtil.mod(ahrs.getAngle() * 2 * Math.PI / 360, Math.PI * 2));
    }
